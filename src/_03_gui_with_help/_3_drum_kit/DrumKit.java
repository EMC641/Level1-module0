...
public class DrumKit implements MouseListener {
    ...
    public void run() {
    	...
    	drumLabel = createLabelImage(imageSnare);
    	...
    	String imageCymbal = "cymbal.jpg";
    	snareLabel = createLabelImage(imageCymbal);
    	panel.add(snareLabel);
    	drumLabel.addMouseListener(this);
